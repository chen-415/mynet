...
def niqe(inputImgData):
    ...
    # TODO: memoize
    params = scipy.io.loadmat(join(module_path, 'data', '/media/happy507/DataSpace1/liuyuxin/downloads/GCANet_train+(1)/GCANet_train/niqe_image_params.mat'))
...
if __name__ == "__main__":
    path = '/media/happy507/DataSpace1/liuyuxin/even_results/net2_results/outdoor_results/Net_results'
    # 获取文件夹中的所有图像文件
