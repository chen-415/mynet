...
parser.add_argument('--dataset', default="/media/happy507/DataSpace1/zhangzijiao/ITS/train/", type=str, help='Path of the training dataset(.h5)')
...
training_settings=[
    {'nEpochs': 100, 'lr': 1e-4, 'step': 50, 'lr_decay': 0.75}
]
